...
def wing_structural_layout(vehicle, xutip, yutip,
    ...
    # Input:
    # wing['rear_spar'] = Posicao da longarina traseira (fracional)
    ...
    # LT externa
    x1aux = (wing['rear_spar']*wing['kink_chord']+bdiv2*fquebra*np.tan(rad*wing['sweep_leading_edge']))
    xlte = [x1aux, (bdiv2*np.tan(rad*wing['sweep_leading_edge'])+wing['rear_spar']*wing['tip_chord'])]
    ...
    inclnt = x1aux-(bdiv2*np.tan(rad*wing['sweep_leading_edge'])+wing['rear_spar']*wing['tip_chord'])
    ...
    xnq.append(xquebraBA+wing['rear_spar']*wing['kink_chord'])
    ynq.append(yquebra)
    ynq.append(ynq[0])
    ...
    # traseira)
    x1aux = xquebraBA + wing['rear_spar']*wing['kink_chord']
    y1aux = yquebra

    x2aux = bdiv2*np.tan(rad*wing['sweep_leading_edge']) + wing['rear_spar']*wing['tip_chord']
    y2aux = bdiv2
    ...
    xail = []
    yail = []
    xail.append(bdiv2*np.tan(rad*wing['sweep_leading_edge'])+wing['rear_spar']*wing['tip_chord'])
    yail.append(bdiv2)
...
#     hold on
    ...
    wing['rear_spar'] = (xflapi[2]+xltintern)/2
