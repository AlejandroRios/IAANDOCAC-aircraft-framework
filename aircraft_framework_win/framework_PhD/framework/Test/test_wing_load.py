...
theta,delta,sigma,T_ISA,P_ISA,rho_ISA,a = atmosphere_ISA_deviation(maximum_altitude,delta_ISA)
mach_design = 0.78
...
while CL<CL_constraint:
    ...
    theta,delta,sigma,T_ISA,P_ISA,rho_ISA,a = atmosphere_ISA_deviation(altitude,delta_ISA)
    CL = ((2*load_factor)/(gamma*P_ISA*mach_design*mach_design))*(weight*9.81/wing_surface)
