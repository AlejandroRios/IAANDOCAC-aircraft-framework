...
creator.create("Individual", list, fitness=creator.FitnessMax) #definir individuo
...
toolbox.register("attr_engine_inlet_turbine_temperature", random.randint,1400,1500)
...
toolbox.register("attr_engine_design_point_pressure", random.randint,33000,43000)
